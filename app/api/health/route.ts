...
const healthPayload = {
  ...
  backend_contracts: [
    ...
    },
    {
      ...
      file: '/root/aeronyx/privacy_network/api/vpn_observability.py',
      purpose: 'Fleet-level Rust cutover safety counts, full problem_nodes, and backend-authored actionable_problem_nodes derived from data.nodes[].system.restart_readiness.drain_eta.cutover_guard for the Services Cutover Safety card and Cutover Blockers action queue',
    },
    {
