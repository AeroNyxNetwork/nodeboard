 ...
 *
 * Last Modified: v2.1.0 - [USDT-CAPABILITY-RECOVERY 2026-08-09 by Codex]
...
const en: Copy = {
  ...
  account: 'Private checkout', verifiedCheckout: 'One-time checkout verified',
...
const copyByLocale: Record<Locale, Copy> = {
  ...
  'zh-CN': {
    ...
    account: '私密结账', verifiedCheckout: '一次性结账已验证', choosePlan: '选择会员', chooseNetwork: '选择支付网络', network: '网络', monthly: '月付', yearly: '年付', days: '天',
  ...
  'zh-TW': {
    ...
    account: '私密結帳', verifiedCheckout: '一次性結帳已驗證', choosePlan: '選擇會員', chooseNetwork: '選擇支付網路', network: '網路', monthly: '月付', yearly: '年付', days: '天',
  ...
  ja: {
    ...
    account: 'プライベート決済', verifiedCheckout: '一回限りの決済を確認済み', choosePlan: 'プランを選択', chooseNetwork: '支払いネットワーク', network: 'ネットワーク', monthly: '月額', yearly: '年額', days: '日', continue: '支払いを作成',
  ...
  ko: {
    ...
    account: '비공개 결제', verifiedCheckout: '일회용 결제 확인됨', choosePlan: '멤버십 선택', chooseNetwork: '결제 네트워크 선택', network: '네트워크', monthly: '월간', yearly: '연간', days: '일', continue: '결제 만들기',
  ...
  ru: {
    ...
    account: 'Приватная оплата', verifiedCheckout: 'Одноразовый платёж подтверждён', choosePlan: 'Выберите подписку', chooseNetwork: 'Выберите сеть', network: 'Сеть', monthly: 'Ежемесячно', yearly: 'Ежегодно', days: 'дней', continue: 'Создать платёж',
